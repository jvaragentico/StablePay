...
export default function Home() {
  ...
  return <main>
    ...
    <footer><span>StablePay Commerce</span><span>Built on Base · Testnet only · No real funds</span><a href="https://github.com/jvaragentico/StablePay" target="_blank" rel="noreferrer">View source <ExternalLink size={13}/></a></footer>
